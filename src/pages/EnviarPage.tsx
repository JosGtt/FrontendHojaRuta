...
const EnviarPage: React.FC = () => {
  ...
  return (
    <div style={{ background: 'var(--color-vino-oscuro)' }} className="p-6 text-white shadow border border-[rgba(255,255,255,0.04)]">
      {/* Header */}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Comentarios */}
        <label className="flex flex-col">
          <span className="text-sm text-white/80 mb-2">Comentarios adicionales</span>
          <textarea 
            value={comentarios} 
